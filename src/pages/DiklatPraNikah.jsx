...
const DiklatPraNikah = () => {
  return (
    <>
      ...
      <div className={`${styles.paddingX} ${styles.flexCenter} bg-Gray1 pt-[60px]`}>
        <div className={`${styles.boxWidth}  my-20 flex flex-col gap-20`}>
          ...
          <div className="flex flex-col justify-center items-center text-center gap-9">
            ...
            <p className="w-full sm:w-[90%] md:w-[70%]">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Explicabo eaque possimus
              ipsa ipsum cumque nihil quas voluptates quae. Reprehenderit, animi!
            </p>
          </div>
          {/* Card Diklat */}
              ...
              <div
                ...
                <div className="p-3 flex flex-col lg:flex-row gap-8 ">
                  ...
                  <div>
                    ...
                    />
                    <Button label={"Download Poster"} outline icon={PiDownloadSimpleBold} />
                  </div>
                  {/* Right Side */}
                  <div className="flex flex-col justify-between gap-3">
                    {/* Hari/Tanggal */}
                    <h1 className="text-3xl font-bold text-greenText ">Rabu, 22 Oktober 2023</h1>
                      ...
                      <div className=" flex flex-col gap-2">
                        ...
                        <div className="flex">
                          ...
                          <p className=" text-base ">
                            Lt. 3 Gedung Diklat, Masjid Raudhatul Jannah Islamic Center, Jl. Tuanku
                            Tambusai,Pekanbaru
                          </p>
                        </div>
                        <hr />
                        ...
                        <div className="flex">
                          ...
                          <p className=" text-base ">
                            Sertifikat, Materi Diklat, Praktek, Alat Tulis, Ruangan AC
                          </p>
                        </div>
                        <hr />
                    ...
                    <div className="flex flex-col gap-2 mt-5">
                      ...
                      <Button icon={HiOutlinePencilSquare} label={"Daftar Sekarang"} />
                    </div>
                  </div>
                </div>
              </div>
