      ...
      >
        <div className={`${styles.boxWidth}  my-20 flex flex-col gap-20`}>
          ...
          <div className="flex flex-col justify-center items-center text-center gap-9">
            <h1 className="text-judul ">Diklat Wudhu & Sholat</h1>
                    ...
                    <div className="mt-5 flex-col flex gap-2">
                      <div className=" flex flex-col gap-2">
                        ...
                        <div className="flex">
                          ...
                          <p className=" text-base text-black">25 peserta</p>
                        </div>
                        <hr />
                        ...
                        <div className="flex">
                          ...
                          <p className=" text-base text-black">Rp 100.000</p>
                        </div>
...
export default DilatWudhuShalat;
